 ...
 * @version $Id$
 */
public interface PatchBank extends Patch {
	 ...
	 */
	void put(Patch singlePatch, int patchNum);

	/**
	 * Delete a Single patch in a bank patch. A recommented implementation is putting a default patch created by a
	 * single driver, and put a null name.
	 */
