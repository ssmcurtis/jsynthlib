 ...
 * @version $Id$
 */
public class JSynthManufacturerLookup {
	private static final  String normal[] = { "Sequential Circuits", // 0x01
			"IDP",
			"Voytera",
			"Moog Music",
			"Passport Design",
	...
	private static final String extended00[] = { "Warner New Media", // 0x01
			"UNASSIGNED!",
			"UNASSIGNED!",
			"UNASSIGNED!",
			"UNASSIGNED!",
	...
	private static String extended10[] = { "Crystalake Multimedia", // 0x01
	...
	private static final String extended20[] = { "Dream", // 0x00 !!!!
			"Strand Lighting",
