 ...
 */
public class VirusProgBankDriver extends SynthDriverBank {
	...
	public VirusProgBankDriver() {
		super("Prog Bank", "Kenneth L. Martinez", Virus.PATCH_COUNT_IN_BANK, 4);
		sysexID = Virus.DEVICE_SYSEX_ID;
		sysexRequestDump = new SysexHandler("F0 00 20 33 01 10 32 *bankNum* F7");
		singleSysexID = Virus.DEVICE_SYSEX_ID;
		singleSize = 267;
	...
	public PatchDataImpl createNewPatch() {
		...
		System.arraycopy(Virus.NEW_PROGRAM_PATCH, 0, tmp, 0, singleSize);
