...
public class NordStageDevice extends Device {
	...
	private static final String INFO_TEXT = "This is a beta driver for the "
			...
			+ "bugs present. It has been tested using a Nord Stage Rev. B with " + "OS 2.16.";
	...
	public NordStageDevice() {
		...
		super("Clavia", "Nord Stage", "F07E000602426E00080000000001F7", INFO_TEXT, "Fredrik Zetterberg & James Fry");
