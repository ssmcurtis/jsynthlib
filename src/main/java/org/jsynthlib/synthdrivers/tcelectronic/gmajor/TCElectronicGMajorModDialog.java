...
public class TCElectronicGMajorModDialog extends JDialog implements ItemListener {
	...
	private final String[][] blockString = {
			...
			{ "", "", "", "[Shifter] Pan1" }, { "", "", "", "[Shifter] Pan2" }, { "", "", "", "[Shifter] FB1" },
			{ "", "", "", "[Shifter] FB2" }, { "", "", "", "[Shifter] Mix" }, { "", "", "", "[Shifter] OutLev" },
			...
			{ "", "", "[ClasFla] Mix", "[AdvFla] Mix", "" }, { "", "", "[ClasFla] OutLev", "[AdvFla] OutLev", "" },
			{ "[PingPong] Dly", "[Dynamic] Dly", "[Dual] Dly1" }, { "[PingPong] FB", "[Dynamic] FB", "[Dual] Dly2" },
			...
			{ "[PingPong] OutLev", "[Dynamic] OutLev", "[Dual] FB Lo Cut" }, { "", "", "[Dual] Pan1" },
			{ "", "", "[Dual] Pan2" }, { "", "", "[Dual] Mix" }, { "", "", "[Dual] OutLev" },
	...
	public void itemStateChanged(ItemEvent e) {
		if (e.getStateChange() == ItemEvent.SELECTED) {
			...
			listVector.set(
					...
					new TCModListItem(tc.getOfs(), tc.getParam(), modCombo.getSelectedIndex(), minCombo
							.getSelectedIndex(), midCombo.getSelectedIndex(), maxCombo.getSelectedIndex()));
			modList.repaint();
