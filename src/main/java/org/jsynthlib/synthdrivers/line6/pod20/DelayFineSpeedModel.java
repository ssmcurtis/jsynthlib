...
class DelayFineSpeedModel extends ParamModel {
	 ...
	 * scaling factor is calculated as maxSysex / maxCC.
	 */
	private int maxCC;
	...
	/**
	 * Constructs a DelayFineSpeedModel. Patch p is the reference to the patch containing the sysex record. int o is the
	 * offset into the sysex record in non-nibblized bytes, not including the header bytes. int maxCC is the maximum CC
	 * value. int maxSysex is the max sysex value
	 */
	DelayFineSpeedModel(PatchDataImpl p, int o, int maxCC, int maxSysex) {
		super(p, o);
		this.maxCC = maxCC;
	...
	/**
	 * Scales the value of i according maxSysex and sets the sysex value at offset ofs to the result.
	 */
	...
	/**
	 * Returns the value of the three bytes representing the delay speed as an int. The value returned is the composite
