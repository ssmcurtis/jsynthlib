...
class PatchBytes {
	/**
	 * Converts two nibblized bytes to a single byte. The value of ofs refers to the position within the un-nibblized
	 * record.
	 */
	...
	/**
	 * Converts the bytes in a nibblized sysex records to a String, starting at offset, ofs for len bytes. The value of
	 * ofs is the position within the un-nibblized sysex record and the length, len is given in un-nibblized bytes.
	 */
