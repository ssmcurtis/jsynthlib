...
public class YamahaMotifDevice extends Device {
	...
	public YamahaMotifDevice() {
		super("Yamaha", "Motif", "F07E7F06024300417.040000007FF7",
				"This version has librarian support for single voices (drum "
						...
						+ "I will finish the editor support and and support for " + "performances, masters, etc.",
				"Rib Rdb");
	}
	...
	public YamahaMotifDevice(Preferences prefs) {
		...
		/*
		 * addDriver(0,new YamahaMotifBulkConverter()); addDriver(new YamahaMotifSingleDriver()); addDriver(new
		 * YamahaMotifBankDriver()); addDriver(new YamahaMotifMultiDriver()); addDriver(new
		 * YamahaMotifMultiBankDriver()); addDriver(new YamahaMotifEffectDriver()); addDriver(new
		 * YamahaMotifEffectBankDriver()); addDriver(new YamahaMotifDrumsetDriver());
		 */
