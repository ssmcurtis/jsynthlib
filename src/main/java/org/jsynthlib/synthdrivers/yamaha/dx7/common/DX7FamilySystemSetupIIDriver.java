...
public class DX7FamilySystemSetupIIDriver extends SynthDriverPatchImpl {
	byte[] initSysex;
	...
	public JSLFrame editPatch(PatchDataImpl p) {
		return new DX7FamilySystemSetupIIEditor(getManufacturerName() + " " + getModelName() + " \"" + getPatchType()
