...
public class DX7FamilyVoiceBankDriver extends SynthDriverBank {
	...
	public static final int dxPatchNameSize = 10; // size of patchname of single patch
	public static final int dxPatchNameOffset = 118; // offset in packed bank format
	public static final int dxSinglePackedSize = 128; // size of single patch in packed bank format
	public static final int dxSysexHeaderSize = 6; // length of sysex header
	...
	public String getPatchName(PatchDataImpl p, int patchNum) {
		...
		try {
			StringBuffer s = new StringBuffer(new String(((PatchDataImpl) p).getSysex(), nameStart, dxPatchNameSize, "US-ASCII"));
			return s.toString();
	...
	public void putPatch(PatchDataImpl bank, PatchDataImpl p, int patchNum) {
		...
		// Depth
		// (0-99)
		((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 11] = (byte) ((((PatchDataImpl) p).getSysex()[6 + 12] * 4 + ((PatchDataImpl) p)
				.getSysex()[6 + 11])); // Kbd
		// Level
		// Scale
		// Right
		...
		// .(0-3)
		// | Left Curve ...............(0-3)
		((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 12] = (byte) ((((PatchDataImpl) p).getSysex()[6 + 20] * 8 + ((PatchDataImpl) p)
				.getSysex()[6 + 13])); // Osc
		// Detune
		// .................(0-14)
		// | Kbd Rate Scaling .........(0-7)
		((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 13] = (byte) ((((PatchDataImpl) p).getSysex()[6 + 15] * 4 + ((PatchDataImpl) p)
				.getSysex()[6 + 14])); // Key
		// Velocity
		// Sensitivity
		// ....(0-7)
		...
		// Level
		// ......(0-99)
		((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 15] = (byte) ((((PatchDataImpl) p).getSysex()[6 + 18] * 2 + ((PatchDataImpl) p)
				.getSysex()[6 + 17])); // Osc
		// Frequency
		// Coarse
		// .......(0-31)
		...
		// Depth
		// (0-99)
		((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 28] = (byte) ((((PatchDataImpl) p).getSysex()[6 + 33] * 4 + ((PatchDataImpl) p)
				.getSysex()[6 + 32])); // Kbd
		// Level
		// Scale
		// Right
		...
		// .(0-3)
		// | Left Curve ...............(0-3)
		((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 29] = (byte) ((((PatchDataImpl) p).getSysex()[6 + 41] * 8 + ((PatchDataImpl) p)
				.getSysex()[6 + 34])); // Osc
		// Detune
		// .................(0-14)
		// | Kbd Rate Scaling .........(0-7)
		((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 30] = (byte) ((((PatchDataImpl) p).getSysex()[6 + 36] * 4 + ((PatchDataImpl) p)
				.getSysex()[6 + 35])); // Key
		// Velocity
		// Sensitivity
		// ....(0-7)
		...
		// Level
		// ......(0-99)
		((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 32] = (byte) ((((PatchDataImpl) p).getSysex()[6 + 39] * 2 + ((PatchDataImpl) p)
				.getSysex()[6 + 38])); // Osc
		// Frequency
		// Coarse
		// .......(0-31)
		...
		// Depth
		// (0-99)
		((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 45] = (byte) ((((PatchDataImpl) p).getSysex()[6 + 54] * 4 + ((PatchDataImpl) p)
				.getSysex()[6 + 53])); // Kbd
		// Level
		// Scale
		// Right
		...
		// .(0-3)
		// | Left Curve ...............(0-3)
		((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 46] = (byte) ((((PatchDataImpl) p).getSysex()[6 + 62] * 8 + ((PatchDataImpl) p)
				.getSysex()[6 + 55])); // Osc
		// Detune
		// .................(0-14)
		// | Kbd Rate Scaling .........(0-7)
		((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 47] = (byte) ((((PatchDataImpl) p).getSysex()[6 + 57] * 4 + ((PatchDataImpl) p)
				.getSysex()[6 + 56])); // Key
		// Velocity
		// Sensitivity
		// ....(0-7)
		...
		// Level
		// ......(0-99)
		((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 49] = (byte) ((((PatchDataImpl) p).getSysex()[6 + 60] * 2 + ((PatchDataImpl) p)
				.getSysex()[6 + 59])); // Osc
		// Frequency
		// Coarse
		// .......(0-31)
		...
		// Depth
		// (0-99)
		((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 62] = (byte) ((((PatchDataImpl) p).getSysex()[6 + 75] * 4 + ((PatchDataImpl) p)
				.getSysex()[6 + 74])); // Kbd
		// Level
		// Scale
		// Right
		...
		// .(0-3)
		// | Left Curve ...............(0-3)
		((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 63] = (byte) ((((PatchDataImpl) p).getSysex()[6 + 83] * 8 + ((PatchDataImpl) p)
				.getSysex()[6 + 76])); // Osc
		// Detune
		// .................(0-14)
		// | Kbd Rate Scaling .........(0-7)
		((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 64] = (byte) ((((PatchDataImpl) p).getSysex()[6 + 78] * 4 + ((PatchDataImpl) p)
				.getSysex()[6 + 77])); // Key
		// Velocity
		// Sensitivity
		// ....(0-7)
		...
		// Level
		// ......(0-99)
		((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 66] = (byte) ((((PatchDataImpl) p).getSysex()[6 + 81] * 2 + ((PatchDataImpl) p)
				.getSysex()[6 + 80])); // Osc
		// Frequency
		// Coarse
		// .......(0-31)
		...
		// Depth
		// (0-99)
		((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 79] = (byte) ((((PatchDataImpl) p).getSysex()[6 + 96] * 4 + ((PatchDataImpl) p)
				.getSysex()[6 + 95])); // Kbd
		// Level
		// Scale
		// Right
		...
		// .(0-3)
		// | Left Curve ...............(0-3)
		((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 80] = (byte) ((((PatchDataImpl) p).getSysex()[6 + 104] * 8 + ((PatchDataImpl) p)
				.getSysex()[6 + 97])); // Osc
		// Detune
		// .................(0-14)
		// | Kbd Rate Scaling .........(0-7)
		((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 81] = (byte) ((((PatchDataImpl) p).getSysex()[6 + 99] * 4 + ((PatchDataImpl) p)
				.getSysex()[6 + 98])); // Key
		// Velocity
		// Sensitivity
		// ....(0-7)
		...
		// Level
		// ......(0-99)
		((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 83] = (byte) ((((PatchDataImpl) p).getSysex()[6 + 102] * 2 + ((PatchDataImpl) p)
				.getSysex()[6 + 101])); // Osc
		// Frequency
		// Coarse
		// .......(0-31)
		...
		// Depth
		// (0-99)
		((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 96] = (byte) ((((PatchDataImpl) p).getSysex()[6 + 117] * 4 + ((PatchDataImpl) p)
				.getSysex()[6 + 116])); // Kbd
		// Level
		// Scale
		// Right
		...
		// .(0-3)
		// | Left Curve ...............(0-3)
		((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 97] = (byte) ((((PatchDataImpl) p).getSysex()[6 + 125] * 8 + ((PatchDataImpl) p)
				.getSysex()[6 + 118])); // Osc
		// Detune
		// .................(0-14)
		// | Kbd Rate Scaling .........(0-7)
		((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 98] = (byte) ((((PatchDataImpl) p).getSysex()[6 + 120] * 4 + ((PatchDataImpl) p)
				.getSysex()[6 + 119])); // Key
		// Velocity
		// Sensitivity
		// ....(0-7)
		...
		// Level
		// ......(0-99)
		((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 100] = (byte) ((((PatchDataImpl) p).getSysex()[6 + 123] * 2 + ((PatchDataImpl) p)
				.getSysex()[6 + 122])); // Osc
		// Frequency
		// Coarse
		// .......(0-31)
		...
		// Select
		// .........(0-31)
		((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 111] = (byte) ((((PatchDataImpl) p).getSysex()[6 + 136] * 8 + ((PatchDataImpl) p)
				.getSysex()[6 + 135])); // Oscillator
		// Sync
		// .............(0-1)|
		// Feedback
		// (0-7)
	...
	public PatchDataImpl extractPatch(PatchDataImpl bank, int patchNum) // Gets a patch from the bank, converting it as
																		// needed
	{
		try {
			...
			// .................(0-99)
			sysex[6 + 8] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 8])); // Kbd Level Scale
																										// Break
			// Point (0-99)
			sysex[6 + 9] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 9])); // Kbd Level Scale
																										// Left
			// Depth .(0-99)
			sysex[6 + 10] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 10])); // Kbd Level
																										// Scale
			// Right Depth
			// (0-99)
			sysex[6 + 11] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 11] & 3)); // Kbd Level
																											// Scale
			// Left Curve
			// ..(0-3)
			sysex[6 + 12] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 11] & 12) / 4); // Kbd
																													// Level
			// Scale
			// Right
			// Curve
			...
			// Scaling
			// ............(0-7)
			sysex[6 + 14] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 13] & 3)); // Mod
																											// Sensitivity
			// Amplitude
			// ...(0-3)
			...
			// Sensitivity
			// ....(0-7)
			sysex[6 + 16] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 14])); // Operator
																										// Output
			// Level
			// ......(0-99)
			...
			// Coarse
			// .......(0-31)
			sysex[6 + 19] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 16])); // Osc Frequency
																										// Fine
			// .........(0-99)
			...
			// .................(0-99)
			sysex[6 + 29] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 25])); // Kbd Level
																										// Scale
			// Break Point
			// (0-99)
			sysex[6 + 30] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 26])); // Kbd Level
																										// Scale
			// Left Depth
			// .(0-99)
			sysex[6 + 31] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 27])); // Kbd Level
																										// Scale
			// Right Depth
			// (0-99)
			sysex[6 + 32] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 28] & 3)); // Kbd Level
																											// Scale
			// Left Curve
			// ..(0-3)
			sysex[6 + 33] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 28] & 12) / 4); // Kbd
																													// Level
			// Scale
			// Right
			// Curve
			...
			// Scaling
			// ............(0-7)
			sysex[6 + 35] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 30] & 3)); // Mod
																											// Sensitivity
			// Amplitude
			// ...(0-3)
			...
			// Sensitivity
			// ....(0-7)
			sysex[6 + 37] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 31])); // Operator
																										// Output
			// Level
			// ......(0-99)
			...
			// Coarse
			// .......(0-31)
			sysex[6 + 40] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 33])); // Osc Frequency
																										// Fine
			// .........(0-99)
			...
			// .................(0-99)
			sysex[6 + 50] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 42])); // Kbd Level
																										// Scale
			// Break Point
			// (0-99)
			sysex[6 + 51] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 43])); // Kbd Level
																										// Scale
			// Left Depth
			// .(0-99)
			sysex[6 + 52] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 44])); // Kbd Level
																										// Scale
			// Right Depth
			// (0-99)
			sysex[6 + 53] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 45] & 3)); // Kbd Level
																											// Scale
			// Left Curve
			// ..(0-3)
			sysex[6 + 54] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 45] & 12) / 4); // Kbd
																													// Level
			// Scale
			// Right
			// Curve
			...
			// Scaling
			// ............(0-7)
			sysex[6 + 56] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 47] & 3)); // Mod
																											// Sensitivity
			// Amplitude
			// ...(0-3)
			...
			// Sensitivity
			// ....(0-7)
			sysex[6 + 58] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 48])); // Operator
																										// Output
			// Level
			// ......(0-99)
			...
			// Coarse
			// .......(0-31)
			sysex[6 + 61] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 50])); // Osc Frequency
																										// Fine
			// .........(0-99)
			...
			// .................(0-99)
			sysex[6 + 71] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 59])); // Kbd Level
																										// Scale
			// Break Point
			// (0-99)
			sysex[6 + 72] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 60])); // Kbd Level
																										// Scale
			// Left Depth
			// .(0-99)
			sysex[6 + 73] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 61])); // Kbd Level
																										// Scale
			// Right Depth
			// (0-99)
			sysex[6 + 74] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 62] & 3)); // Kbd Level
																											// Scale
			// Left Curve
			// ..(0-3)
			sysex[6 + 75] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 62] & 12) / 4); // Kbd
																													// Level
			// Scale
			// Right
			// Curve
			...
			// Scaling
			// ............(0-7)
			sysex[6 + 77] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 64] & 3)); // Mod
																											// Sensitivity
			// Amplitude
			// ...(0-3)
			...
			// Sensitivity
			// ....(0-7)
			sysex[6 + 79] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 65])); // Operator
																										// Output
			// Level
			// ......(0-99)
			...
			// Coarse
			// .......(0-31)
			sysex[6 + 82] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 67])); // Osc Frequency
																										// Fine
			// .........(0-99)
			...
			// .................(0-99)
			sysex[6 + 92] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 76])); // Kbd Level
																										// Scale
			// Break Point
			// (0-99)
			sysex[6 + 93] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 77])); // Kbd Level
																										// Scale
			// Left Depth
			// .(0-99)
			sysex[6 + 94] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 78])); // Kbd Level
																										// Scale
			// Right Depth
			// (0-99)
			sysex[6 + 95] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 79] & 3)); // Kbd Level
																											// Scale
			// Left Curve
			// ..(0-3)
			sysex[6 + 96] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 79] & 12) / 4); // Kbd
																													// Level
			// Scale
			// Right
			// Curve
			...
			// Scaling
			// ............(0-7)
			sysex[6 + 98] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 81] & 3)); // Mod
																											// Sensitivity
			// Amplitude
			// ...(0-3)
			...
			// Sensitivity
			// ....(0-7)
			sysex[6 + 100] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 82])); // Operator
																											// Output
			// Level
			// ......(0-99)
			...
			// Coarse
			// .......(0-31)
			sysex[6 + 103] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 84])); // Osc
																											// Frequency
																											// Fine
			// .........(0-99)
			...
			// .................(0-99)
			sysex[6 + 113] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 93])); // Kbd Level
																											// Scale
			// Break Point
			// (0-99)
			sysex[6 + 114] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 94])); // Kbd Level
																											// Scale
			// Left Depth
			// .(0-99)
			sysex[6 + 115] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 95])); // Kbd Level
																											// Scale
			// Right Depth
			// (0-99)
			sysex[6 + 116] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 96] & 3)); // Kbd
																												// Level
			// Scale Left
			// Curve ..(0-3)
			sysex[6 + 117] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 96] & 12) / 4); // Kbd
																													// Level
			// Scale
			// Right
			// Curve
			...
			// Sensitivity
			// ....(0-7)
			sysex[6 + 121] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 99])); // Operator
																											// Output
			// Level
			// ......(0-99)
			sysex[6 + 122] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 100] & 1)); // Osc
																												// Mode
			// ....................(0-1)
			sysex[6 + 123] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 100] & 62) / 2); // Osc
																													...
																													// Coarse
																													// .......(0-31)
			sysex[6 + 124] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 101])); // Osc
																											// Frequency
			// Fine
			// .........(0-99)
			...
			// ***** other Parameters *****
			sysex[6 + 126] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 102])); // Pitch EG
																											// Rate 1
			// ............(0-99)
			sysex[6 + 127] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 103])); // Pitch EG
																											// Rate 2
			// ............(0-99)
			sysex[6 + 128] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 104])); // Pitch EG
																											// Rate 3
			// ............(0-99)
			sysex[6 + 129] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 105])); // Pitch EG
																											// Rate 4
			// ............(0-99)
			sysex[6 + 130] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 106])); // Pitch EG
																											// Level 1
			// ...........(0-99)
			sysex[6 + 131] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 107])); // Pitch EG
																											// Level 2
			// ...........(0-99)
			sysex[6 + 132] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 108])); // Pitch EG
																											// Level 3
			// ...........(0-99)
			sysex[6 + 133] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 109])); // Pitch EG
																											// Level 4
			// ...........(0-99)
			...
			// ....................(0-99)
			sysex[6 + 141] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 116] & 1)); // LFO
																												// Sync
			// ....................(0-1)
			sysex[6 + 142] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 116] & 14) / 2); // LFO
																													// Wave
																													// ....................(0-5)
			...
			// .................
			// (0-48)
			sysex[6 + 145] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 118])); // Voice name
																											// 1
			// ..............
			// ASCII
			sysex[6 + 146] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 119])); // Voice name
																											// 2
			// ..............
			// ASCII
			sysex[6 + 147] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 120])); // Voice name
																											// 3
			// ..............
			// ASCII
			sysex[6 + 148] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 121])); // Voice name
																											// 4
			// ..............
			// ASCII
			sysex[6 + 149] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 122])); // Voice name
																											// 5
			// ..............
			// ASCII
			sysex[6 + 150] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 123])); // Voice name
																											// 6
			// ..............
			// ASCII
			sysex[6 + 151] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 124])); // Voice name
																											// 7
			// ..............
			// ASCII
			sysex[6 + 152] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 125])); // Voice name
																											// 8
			// ..............
			// ASCII
			sysex[6 + 153] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 126])); // Voice name
																											// 9
			// ..............
			// ASCII
			sysex[6 + 154] = (byte) ((((PatchDataImpl) bank).getSysex()[getPatchStart(patchNum) + 127])); // Voice name
																											// 10
			// ..............
			// ASCII
