...
public class DX7FamilyStrings {
	public final static void dxShowInformation(String driver, String string) {
		JOptionPane.showMessageDialog(PatchBayApplication.getInstance(), driver + "Driver:" + string, driver + "Driver",
				JOptionPane.INFORMATION_MESSAGE);
	}

	public final static void dxShowError(String driver, String string) {
		JOptionPane.showMessageDialog(null, string, driver + "Driver Error", JOptionPane.ERROR_MESSAGE);
	}
