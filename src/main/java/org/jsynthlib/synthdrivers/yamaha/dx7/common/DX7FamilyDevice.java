...
public class DX7FamilyDevice extends Device {
	...
	public DX7FamilyDevice(String manufacturerName, String modelName, String inquiryID, String infoText,
			String authors, int sPBPFlag, int swOffMemProtFlag, int tipsMsgFlag, Preferences prefs) {
		super(manufacturerName, modelName, inquiryID, infoText, authors);
	...
	public JPanel config() {
		...
		/*
		 * c.gridx=0;c.gridy=1;c.gridwidth=3;c.gridheight=2; panel.add(new JLabel("Synthesizer Name"),c); final
		 * JTextField sl = new JTextField(getSynthName()); sl.addActionListener(new ActionListener() { public void
		 * actionPerformed(ActionEvent e) { setSynthName(sl.getText()); } });
		 * c.gridx=3;c.gridy=1;c.gridwidth=3;c.gridheight=2; panel.add(sl,c);
		 * c.gridx=4;c.gridy=1;c.gridwidth=3;c.gridheight=1; panel.add(new JLabel(" ( free choosable )"),c);
		 */
