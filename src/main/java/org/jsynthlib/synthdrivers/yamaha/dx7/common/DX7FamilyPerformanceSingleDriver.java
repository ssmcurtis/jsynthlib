...
public class DX7FamilyPerformanceSingleDriver extends SynthDriverPatchImpl {
	byte[] initSysex;
	...
	public JSLFrame editPatch(PatchDataImpl p) {
		return new DX7FamilyPerformanceEditor(getManufacturerName() + " " + getModelName() + " \"" + getPatchType()
