...
public class DX7FamilyAdditionalVoiceSingleDriver extends SynthDriverPatchImpl {
	byte[] initSysex;
	...
	public JSLFrame editPatch(PatchDataImpl p) {
		return new DX7FamilyAdditionalVoiceEditor(getManufacturerName() + " " + getModelName() + " \"" + getPatchType()
