...
public class YamahaTX7Strings extends DX7FamilyStrings {
	protected static final String INFO_TEXT = "This JSynthLib \"Yamaha TX7\" device driver supports the following patch types"
	...
	protected final static String EDIT_BANK_PERFORMANCE_STRING = "\n\nThe TX7 uses only 32 single performance patches by itself."
			...
			+ "\nan additional DX7 (32 voices) or DX9 (20 voices)" + AVOID_MSG_STRING;
