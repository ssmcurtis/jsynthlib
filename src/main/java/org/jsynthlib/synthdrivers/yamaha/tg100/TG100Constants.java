...
public class TG100Constants {
	...
	public static final String[] PANPOT = { "center", "right + 1", "right + 2", "right + 3", "right + 4", "right + 5",
			"right + 6", "right + 7", "left - 7", "left - 6", "left - 5", "left - 4", "left - 3", "left - 2",
			"left - 1" };
	...
	public static final String[] VELOCITY_CURVE = { "curve-1", "curve-2", "curve-3", "curve-4", "curve-5", "curve-6",
			"curve-7", "curve-8" };
