...
public class YamahaDX100BankDriver extends BankDriver {
	...
	public void putPatch(Patch bank, Patch p, int patchNum) {
		...
		((Patch) bank).sysex[getPatchStart(patchNum) + 6] = (byte) ((((Patch) p).sysex[55 - 41] * 64
				+ ((Patch) p).sysex[54 - 41] * 8 + ((Patch) p).sysex[56 - 41]));// ame ebs kvs
		...
		((Patch) bank).sysex[getPatchStart(patchNum) + 9] = (byte) ((((Patch) p).sysex[53 - 41] * 8 + ((Patch) p).sysex[59 - 41])); // rs
																																							// dbt
		...
		((Patch) bank).sysex[getPatchStart(patchNum) + 16] = (byte) ((((Patch) p).sysex[-41 + 55 + 13 * 1]
				* 64 + ((Patch) p).sysex[-41 + 54 + 13 * 1] * 8 + ((Patch) p).sysex[-41 + 56 + 13 * 1]));// ame
																														// ebs
																														// kvs
		...
		((Patch) bank).sysex[getPatchStart(patchNum) + 19] = (byte) ((((Patch) p).sysex[-41 + 53 + 13 * 1] * 8 + ((Patch) p).sysex[-41 + 59 + 13 * 1])); // rs
																																												// dbt
		...
		((Patch) bank).sysex[getPatchStart(patchNum) + 26] = (byte) ((((Patch) p).sysex[-41 + 55 + 13 * 2]
				* 64 + ((Patch) p).sysex[-41 + 54 + 13 * 2] * 8 + ((Patch) p).sysex[-41 + 56 + 13 * 2]));// ame
																														// ebs
																														// kvs
		...
		((Patch) bank).sysex[getPatchStart(patchNum) + 29] = (byte) ((((Patch) p).sysex[-41 + 53 + 13 * 2] * 8 + ((Patch) p).sysex[-41 + 59 + 13 * 2])); // rs
																																												// dbt
		...
		((Patch) bank).sysex[getPatchStart(patchNum) + 36] = (byte) ((((Patch) p).sysex[-41 + 55 + 13 * 3]
				* 64 + ((Patch) p).sysex[-41 + 54 + 13 * 3] * 8 + ((Patch) p).sysex[-41 + 56 + 13 * 3]));// ame
																														// ebs
																														// kvs
		...
		((Patch) bank).sysex[getPatchStart(patchNum) + 39] = (byte) ((((Patch) p).sysex[-41 + 53 + 13 * 3] * 8 + ((Patch) p).sysex[-41 + 59 + 13 * 3])); // rs
																																												// dbt

		((Patch) bank).sysex[getPatchStart(patchNum) + 40] = (byte) ((((Patch) p).sysex[-41 + 105] * 64
				+ ((Patch) p).sysex[-41 + 100] * 8 + ((Patch) p).sysex[-41 + 99]));// sync fbl alg
		...
		((Patch) bank).sysex[getPatchStart(patchNum) + 45] = (byte) ((((Patch) p).sysex[-41 + 107] * 16
				+ ((Patch) p).sysex[-41 + 108] * 4 + ((Patch) p).sysex[-41 + 106]));// pms ams lfw
		...
		((Patch) bank).sysex[getPatchStart(patchNum) + 48] = (byte) ((((Patch) p).sysex[-41 + 117] * 16
				+ ((Patch) p).sysex[-41 + 110] * 8 + ((Patch) p).sysex[-41 + 115] * 4
				+ ((Patch) p).sysex[-41 + 116] * 2 + ((Patch) p).sysex[-41 + 112]));// ch mo su po pm
		((Patch) bank).sysex[getPatchStart(patchNum) + 49] = (byte) ((((Patch) p).sysex[-41 + 113])); // porta
																													// time
		((Patch) bank).sysex[getPatchStart(patchNum) + 50] = (byte) ((((Patch) p).sysex[-41 + 114])); // footcontrol

		System.arraycopy(((Patch) p).sysex, 118 - 41, ((Patch) bank).sysex, getPatchStart(patchNum) + 51,
				22);
	...
	public Patch getPatch(Patch bank, int patchNum) {
		try {
			...
			sysex[25] = (byte) ((((Patch) bank).sysex[getPatchStart(patchNum) + 9 + 10] & 24) / 8);// rate
																											// scaling;
			...
			sysex[38] = (byte) ((((Patch) bank).sysex[getPatchStart(patchNum) + 9 + 20] & 24) / 8);// rate
																											// scaling;
			...
			sysex[51] = (byte) ((((Patch) bank).sysex[getPatchStart(patchNum) + 9 + 30] & 24) / 8);// rate
																											// scaling;
