 ...
 * 
 * Known issues: Midi channel is partly fixed to 0. This is set in the third byte to be send, actually it's four lower
 * bits is exacty the channel to be used
 * 
...
public class KorgX3SingleDriver extends SynthDriverPatchImpl {
	...
	private byte[] programMode = { (byte) 0xF0, (byte) 0x42, 0, (byte) 0x35, (byte) 0x4E, (byte) 0x02, (byte) 0x00,
			(byte) 0xF7 };
	private byte[] programEditMode = { (byte) 0xF0, (byte) 0x42, 0, (byte) 0x35, (byte) 0x4E, (byte) 0x03, (byte) 0x00,
			(byte) 0xF7 };
	...
	/**
	 * Overrided storePatch. Sends a patch to the current edit buffer on the synthesizer and saves the patch.
	 * 
	 * @param p
	 *            Patch to be sent
	 * @param bankNum
