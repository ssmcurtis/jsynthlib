...
public class WaldorfPulseDevice extends Device {
	public WaldorfPulseDevice() {
		super("Waldorf", "Pulse/Pulse+", null, "This driver supports patch editting for the Waldorf Pulse "
				+ "and Pulse+. Parameters supported by the Pulse+ " + "only are marked with a plus icon.\n"
