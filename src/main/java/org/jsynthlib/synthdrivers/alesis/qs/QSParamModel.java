...
public class QSParamModel implements SysexWidget.IParamModel {
	 ...
	 * header of 7 bytes before counting bytes.
	 * 
	 * @param patch
	...
	/**
	 * Create a new param model, given the starting bit and the size (in bits) of the parameter. Assumes the standard QS
	 * header of 7 bytes before counting bits
	 * 
	 * @param patch
	 *            the underlying patch to modify
	 * @param msBit
	...
	/**
	 * Given an integer representing a new value for the parameter, set the corresponding bits in the actual patch
	 * 
	 * @param value
	...
	/**
	 * Return an integer representing the current value of the parameter from the corresponding bits in the actual patch
	 * 
