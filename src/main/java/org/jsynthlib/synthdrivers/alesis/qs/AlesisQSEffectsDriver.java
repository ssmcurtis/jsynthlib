 ...
 * 
 * Effects program driver for Alesis QS series synths Feb 2002
 * 
...
public class AlesisQSEffectsDriver extends SynthDriverPatchImpl {
	...
	/**
	 * Copied from Driver.java by zjh. Requests a patch dump. If the patch number is 0..127, then use opcode 07 - MIDI
	 * User Effects Dump Request. If the patch number is 128..129, use opcode 09 - MIDI Edit Effects Dump Request. 128
	 * corresponds to the Program mode effects edit buffer, and 129 to the Mix mode effects edit buffer
	 * 
	 * @param bankNum
	 *            not used
	 * @param patchNum
