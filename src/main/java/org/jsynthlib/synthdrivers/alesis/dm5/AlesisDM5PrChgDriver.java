...
public class AlesisDM5PrChgDriver extends SynthDriverPatchImpl {
	 ...
	 */
	private static final SysexHandler SYS_REQ = new SysexHandler(Constants.PROG_CHNG_DUMP_REQ_ID); // System Info Dump
																									// Request
	...
	private static final byte NEW_SYSEX[] = { (byte) 0xF0, (byte) 0x00, (byte) 0x00, (byte) 0x0E, (byte) 0x13,
			(byte) 0x00, (byte) 0x03, (byte) 0x00, (byte) 0x01, (byte) 0x02, (byte) 0x03, (byte) 0x04, (byte) 0x05,
			(byte) 0x06, (byte) 0x07, (byte) 0x08, (byte) 0x09, (byte) 0x0A, (byte) 0x0B, (byte) 0x0C, (byte) 0x0D,
			(byte) 0x0E, (byte) 0x0F, (byte) 0x10, (byte) 0x11, (byte) 0x12, (byte) 0x13, (byte) 0x14, (byte) 0x00,
			...
			(byte) 0x00, (byte) 0x01, (byte) 0x6D, (byte) 0xF7 };
	...
	/**
	 * Send Program Change MIDI message. The Alesis Program Change Table driver does not utilize program change
	 * messages. This method is overriden with a null method.
	 */
	protected void setPatchNum(int patchNum) {
	}

	/**
	 * Send Control Change (Bank Select) MIDI message. The Alesis Program Change Table driver does not utilize bank
	 * select. This method is overriden with a null method.
	 */
