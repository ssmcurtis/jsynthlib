...
public class AlesisDM5SysInfoDriver extends SynthDriverPatchImpl {
	 ...
	 */
	private static final SysexHandler SYS_REQ = new SysexHandler(Constants.SYS_INFO_DUMP_REQ_ID); // System Info Dump
																									// Request
	...
	private static final byte NEW_SYSEX[] = { (byte) 0xF0, (byte) 0x00, (byte) 0x00, (byte) 0x0E, (byte) 0x13,
			(byte) 0x00, (byte) 0x00, (byte) 0x4C, (byte) 0x00, (byte) 0x00, (byte) 0xF7 };
	...
	/**
	 * Send Control Change (Bank Select) MIDI message. The Alesis System Info driver does not utilize bank select. This
	 * method is overriden with a null method.
	 */
