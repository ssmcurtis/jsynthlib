 ...
 * options list, the control value, and the associated NRPNSender based on the associated NRPNModel.
 * 
 * @author Jeff Weber
 */
class DM5ComboBoxWidget extends ComboBoxWidget {
	...
	/**
	 * Updates the comboBox list with the list of objects (Strings) given by options and updates the value of the
	 * associated NRPNSender based on the current value of the associated model.
	 */
