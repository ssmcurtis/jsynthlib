...
public class AlesisDMProParser {
	...
	/**
	 * Gets value from raw bytes. nBits is number of bits No parameter covers more than 2 bytes Arguments are sent
	 * according to docs (compressed, "raw") TODO: Variable names could be more clear
	 */
