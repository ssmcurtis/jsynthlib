...
public class AlesisDMProDevice extends Device {
	private static final String INFO_TEXT = "Known issues: Pitchslider defaults to wrong position when starting editor.\n"
	...
	public AlesisDMProDevice() {
		super("Alesis", "DM Pro", "F07E7F060200000E19000000.F7", INFO_TEXT, "Peter Hageus (peter.hageus@comhem.se)");
	}
