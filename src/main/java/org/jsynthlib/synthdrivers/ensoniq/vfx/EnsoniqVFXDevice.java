 ...
 * Unfortunately, my documentation is not up to date so if this driver does not work with yours, check the sysex size
 * first and then the message types. I can't deal with several version of VFX because I have only one. This could be
 * made with first getting the version and then choosing the good parameters in a table with the version as the key.
 * 
