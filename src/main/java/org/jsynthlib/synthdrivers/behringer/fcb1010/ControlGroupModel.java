 ...
 * enabling/disabling the state of all of the ComboBoxWidgets in the group based on the state of the associated
 * CheckBoxWidget.
 * 
 * @author Jeff Weber
 */
class ControlGroupModel implements ItemListener {
	...
	/**
	 * Constructs a ControlGroupModel given a single CheckBoxWidget and list of ComboBoxWidgets.
	 */
	...
	/**
	 * Detects the state of the CheckBoxWidget and calls the ControlGroupModel.setEnabled method.
	 */
	...
	/**
	 * Sets all of the ComboBoxWidgets in the group to enabled or disabled based on the value of boolean enabled.
	 */
