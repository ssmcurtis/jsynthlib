...
public class RolandJV80Device extends Device {
	private final static String INFO_TEXT = "Setup whether you have an expansion/pcm card/data card installed. "
			...
			+ "For suggestions or comments, please email me " + "at sjbrande@sourceforge.net\n";
