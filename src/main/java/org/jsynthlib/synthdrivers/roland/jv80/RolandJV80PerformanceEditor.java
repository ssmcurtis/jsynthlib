...
public class RolandJV80PerformanceEditor extends PatchEditorFrame {
	...
	JPanel buildCommon(Patch patch) {
		...
		if (isJV80) {
			...
			gbc.gridx = 1;
			gbc.gridy = 1;
			panel.add(new ComboBoxWidget(null, patch, new JVModel(patch, -1, 0x0C), new JVSender(-1, 0x0C),
					new String[] { "LAYER", "ZONE", "SINGLE" }), gbc);
		}
		return panel;
	}
	...
	JPanel buildParts(final Patch patch) {
		...
		for (int tabnr = 0; tabnr < 4; tabnr++) {
			...
			for (int i = 0; i < 2; i++) {
				...
				gbc.gridy++;
				part.add(new CheckBoxWidget(null, patch, new JVModel(patch, partnr, 0x15), new JVSender(partnr, 0x15)),
						gbc);
				gbc.gridy++;
				part.add(new ComboBoxWidget(null, patch, new JVModel(patch, partnr, 0x16), new JVSender(partnr, 0x16),
				...
				gbc.gridy++;
				part.add(new ScrollBarWidget(null, patch, 0, 127, 0, new JVModel(patch, partnr, 0x19), new JVSender(
						partnr, 0x19)), gbc);
				gbc.gridy++;
				part.add(new ScrollBarWidget(null, patch, 0, 127, -64, new JVModel(patch, partnr, 0x1A), new JVSender(
						partnr, 0x1A)), gbc);
				gbc.gridy++;
				part.add(new ScrollBarWidget(null, patch, 16, 112, -64, new JVModel(patch, partnr, 0x1B), new JVSender(
						partnr, 0x1B)), gbc);
				gbc.gridy++;
				part.add(new ScrollBarWidget(null, patch, 14, 114, -64, new JVModel(patch, partnr, 0x1C), new JVSender(
						partnr, 0x1C)), gbc);
				gbc.gridy++;
				part.add(new CheckBoxWidget(null, patch, new JVModel(patch, partnr, 0x1D), new JVSender(partnr, 0x1D)),
						gbc);
				gbc.gridy++;
				part.add(new CheckBoxWidget(null, patch, new JVModel(patch, partnr, 0x1E), new JVSender(partnr, 0x1E)),
						gbc);
				gbc.gridy++;
				part.add(new CheckBoxWidget(null, patch, new JVModel(patch, partnr, 0x1F), new JVSender(partnr, 0x1F)),
						gbc);
				gbc.gridy++;
				part.add(new CheckBoxWidget(null, patch, new JVModel(patch, partnr, 0x20), new JVSender(partnr, 0x20)),
						gbc);
				gbc.gridy++;
				part.add(new CheckBoxWidget(null, patch, new JVModel(patch, partnr, 0x21), new JVSender(partnr, 0x21)),
						gbc);
				gbc.gridy++;
				part.add(new ComboBoxWidget(null, patch, new JVModel(patch, partnr, 0x22), new JVSender(partnr, 0x22),
