...
public final class PadInfo implements Cloneable {
	 ...
	 *            a <code>boolean</code> value
	 */
	public PadInfo(String name, int offset, boolean dualTrigger, boolean dualTriggerActive, boolean padActive) {
		this.name = name;
		this.offset = offset;
	...
	/**
	 * @return a name field value. For dual trigger pad " [head]" or " [Rim]" is appended.
	 */
	/*
	 * public String toString() { return (this.dualTrigger ? (this.name + (this.rim ? " [Rim]" : " [Head]")) :
	 * this.name); }
	 */
