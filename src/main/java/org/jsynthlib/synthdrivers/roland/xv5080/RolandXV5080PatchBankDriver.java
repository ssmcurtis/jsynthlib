...
public class RolandXV5080PatchBankDriver extends BankDriver {
	...
	public String getPatchName(Patch p, int patchNum) {
		try {
			return new String(((Patch) p).getSysex(), RolandXV5080PatchDriver.PATCH_SIZE * patchNum
	...
	public Patch getPatch(Patch bank, int patchNum) {
		try {
			...
			System.arraycopy(((Patch) bank).getSysex(), RolandXV5080PatchDriver.PATCH_SIZE * patchNum, sysex, 0,
