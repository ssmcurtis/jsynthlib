...
public class RolandXV5080PatchBankDriver extends SynthDriverBank {
	...
	public String getPatchName(PatchDataImpl p, int patchNum) {
		try {
			return new String(((PatchDataImpl) p).getSysex(), RolandXV5080PatchDriver.PATCH_SIZE * patchNum
					+ RolandXV5080PatchDriver.PATCH_NAME_START, RolandXV5080PatchDriver.PATCH_NAME_SIZE, "US-ASCII");
	...
	public PatchDataImpl getPatch(PatchDataImpl bank, int patchNum) {
		try {
			...
			ErrorMsgUtil.reportError("Error", "Error in XV5080 Patch Bank Driver", ex);
			return null;
		}
	}
	...
	public void putPatch(PatchDataImpl bank, PatchDataImpl p, int patchNum) {
		...
		((PatchDataImpl) bank).setSysex(HexaUtil.byteArrayReplace(((PatchDataImpl) bank).getSysex(),
				RolandXV5080PatchDriver.PATCH_SIZE * patchNum, RolandXV5080PatchDriver.PATCH_SIZE, pInsert.getSysex(), 0,
				RolandXV5080PatchDriver.PATCH_SIZE));
	}
