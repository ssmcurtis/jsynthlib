...
public class RolandXV5080PatchBankDriver extends BankDriver {
	...
	public String getPatchName(Patch p, int patchNum) {
		try {
			return new String(((Patch) p).sysex, RolandXV5080PatchDriver.PATCH_SIZE * patchNum
	...
	public Patch getPatch(Patch bank, int patchNum) {
		try {
			...
			System.arraycopy(((Patch) bank).sysex, RolandXV5080PatchDriver.PATCH_SIZE * patchNum, sysex, 0,
	...
	public void putPatch(Patch bank, Patch p, int patchNum) {
		...
		((Patch) bank).sysex = Utility.byteArrayReplace(((Patch) bank).sysex,
				RolandXV5080PatchDriver.PATCH_SIZE * patchNum, RolandXV5080PatchDriver.PATCH_SIZE, pInsert.sysex, 0,
				RolandXV5080PatchDriver.PATCH_SIZE);
	}
