...
public class RolandMT32SystemDriver extends SynthDriverPatchImpl {
	...
	public PatchDataImpl createNewPatch() {
		...
		// ErrorMsgUtil.reportStatus ("Checksumcalc " + 5 + " to " + (HSIZE+SSIZE-2) + " into " + (HSIZE+SSIZE-1));
		return p;
	}
	...
	public void requestPatchDump(int bankNum, int patchNum) {
		...
		send(SYS_REQ.toSysexMessage(getChannel(), new NameValue("checkSum", 0x59)));
	}
}
