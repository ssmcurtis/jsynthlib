...
public class RolandMT32DisplayDriver extends Driver {
	...
	/*
	 * public void requestPatchDump(int bankNum, int patchNum) { // The message format here is Request RQ1 // All but
	 * the checksum is already set up in SYS_REQ
	 * 
	 * // send(SYS_REQ.toSysexMessage(getChannel(), // new SysexHandler.NameValue("checkSum", 0x69)
