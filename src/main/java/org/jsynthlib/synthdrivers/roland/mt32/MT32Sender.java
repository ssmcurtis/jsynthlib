...
class MT32Sender extends SysexSender {
	 ...
	 * 
	 * 00-04 F0 41 10 16 12 // start of sysex + header (manufactID, devID, modelID, cmdID) 05-07 aa aa aa // address
	 * 08-(End-2) dd // data (End-1) cc // checksum (End) F7 // end of sysex
	 */
