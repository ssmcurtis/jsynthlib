...
class RolandGP16SingleEditor extends PatchEditorFrame {
	private String[] expAssChoices = new String[] { "Off", "Compressor-Tone", "Compressor-Attack",
			"Compressor-Sustain", "Compressor-Level", "Distortion-Tone", "Distortion-Distortion", "Distortion-Level",
			"Overdrive-Tone", "Overdrive-Drive", "Overdrive-Turbo", "Overdrive-Level", "Picking Filter-Sens",
			"Picking Filter-Cutoff Freq", "Picking Filter-Q", "Picking Filter-Up/Down", "Step Phaser-Rate",
			"Step Phaser-Depth", "Step Phaser-Manual", "Step Phaser-Resonance", "Step Phaser-LFO Step",
			"Parametric EQ-Hi Freq", "Parametric EQ-Hi Level", "Parametric EQ-H.M Freq", "Parametric EQ-H.Mid Q",
			"Parametric EQ-H.M Lev", "Parametric EQ-L.M Freq", "Parametric EQ-L.Mid Q", "Parametric EQ-L.M Lev",
			"Parametric EQ-Lo Freq", "Parametric EQ-Lo Level", "Parametric EQ-Out Lev", "Noise Suppressor-Sens",
			"Noise Suppressor-Release", "Noise Suppressor-Level", "Short Delay-D.Time", "Short Delay-E.Level",
			"Chorus-P.Delay", "Chorus-Rate", "Chorus-Depth", "Chorus-E.Level", "Flanger-Rate", "Flanger-Depth",
			"Flanger-Manual", "Flanger-Resonance", "Pitch Shifter-Balance", "Pitch Shifter-Chromatic",
			"Pitch Shifter-Fine", "Pitch Shifter-F.Back", "Pitch Shifter-P.Delay", "Space-D-Mode", "Auto Panpot-Rate",
			"Auto Panpot-Depth", "Auto Panpot-Mode", "Tap Delay-C.Tap", "Tap Delay-L.Tap", "Tap Delay-R.Tap",
			"Tap Delay-C.Level", "Tap Delay-L.Level", "Tap Delay-R.Level", "Tap Delay-F.Back", "Tap Delay-Cutoff",
	...
	private String[] jointBChoices = new String[] { "Short Delay", "Ch/Fl/PS/Sp", "Auto Panpot", "Tap Delay", "Reverb" };
	...
	public RolandGP16SingleEditor(PatchDataImpl patch) {
		...
		addWidget(misc, new RolandGP16PatchNameWidget("Name", patch), 0, 0, 1, 1, faderVal);
		faderVal++;
		addWidget(misc, new ExpLevScrollBarWidget("Master Volume", patch, 0, 100, 0, new ParamModel(patch, 0x5B + 8),
				new VSender(0x5B), 1), 0, 1, 1, 1, faderVal);
		faderVal++;
		addWidget(misc, new GP16ComboBoxWidget("Output Channel", patch, new ParamModel(patch, 0x63 + 8), new VSender(
				0x63), new String[] { "Channel 1", "Channel 2", "Channel 1&2" }, true), 0, 2, 1, 1, faderVal);
		faderVal++;

		misc.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.RAISED), "Miscellaneous", TitledBorder.CENTER,
				TitledBorder.CENTER));
		...
		for (int dum = 0; dum < 5; dum++) {
			jointWidgetsA[dum] = new GP16ComboBoxWidget("", patch, new ParamModel(patch, dum + 8), new VSender(dum),
					jointAChoices, false, new GP16JointPolice(patch, 0));
			jointWidgetsB[dum] = new GP16ComboBoxWidget("", patch, new BBParamModel(patch, dum + 6 + 8), new VSender(
					dum + 6), jointBChoices, false, new GP16JointPolice(patch, 6));
		...
		joint.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.RAISED), "Effects Sequence",
		...
		expression.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.RAISED), "Expression Pedal",
				TitledBorder.CENTER, TitledBorder.CENTER));
		...
		addWidget(shortD, new ExpLevScrollBarWidget("Sensitivity", patch, 0, 100, 0, new ParamModel(patch, 0x31 + 8),
				new VSender(0x31), 1), 0, 0, 1, 1, faderVal);
		faderVal++;
		addWidget(shortD, new ExpLevScrollBarWidget("Effect Level", patch, 0, 100, 0, new ParamModel(patch, 0x32 + 8),
				new VSender(0x32), 1), 0, 1, 1, 1, faderVal);
		faderVal++;
		addWidget(shortD, new GP16CheckBoxWidget("Effect On", patch, new GP16BitModel(patch, 0x0E + 8, 6),
				new GP16BitSender(patch, 0x0E, 6)), 0, 5, 1, 1, checkVal);
		checkVal--;

		shortD.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.RAISED), "Short Delay", TitledBorder.CENTER,
				TitledBorder.CENTER));
		...
		addWidget(auto, new ExpLevScrollBarWidget("Rate", patch, 0, 100, 0, new ParamModel(patch, 0x42 + 8),
				new VSender(0x42), 1), 0, 0, 1, 1, faderVal);
		faderVal++;
		addWidget(auto, new ExpLevScrollBarWidget("Depth", patch, 0, 100, 0, new ParamModel(patch, 0x43 + 8),
				new VSender(0x43), 1), 0, 1, 1, 1, faderVal);
		faderVal++;
		addWidget(auto, new GP16ComboBoxWidget("Mode", patch, new ParamModel(patch, 0x44 + 8), new VSender(0x44),
				new String[] { "Panning", "Tremolo" }, true), 0, 2, 1, 1, faderVal);
		faderVal++;
		addWidget(auto, new GP16CheckBoxWidget("Effect On", patch, new GP16BitModel(patch, 0x0D + 8, 1),
				new GP16BitSender(patch, 0x0D, 1)), 0, 3, 1, 1, checkVal);
		checkVal--;

		auto.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.RAISED), "Auto Panpot", TitledBorder.CENTER,
				TitledBorder.CENTER));

		JPanel delay = new JPanel();
		delay.setLayout(new GridBagLayout());

		addWidget(delay, new ExpLevScrollBarWidget("Center Tap", patch, 0, 1200, 0, new BigValParamModel(patch,
				0x45 + 8), new BigValSender(0x45), 1), 0, 0, 1, 1, faderVal);
		faderVal++;
		addWidget(delay, new ExpLevScrollBarWidget("Left Tap", patch, 0, 1200, 0,
				new BigValParamModel(patch, 0x47 + 8), new BigValSender(0x47), 1), 0, 1, 1, 1, faderVal);
		faderVal++;
		addWidget(delay, new ExpLevScrollBarWidget("Right Tap", patch, 0, 1200, 0,
				new BigValParamModel(patch, 0x49 + 8), new BigValSender(0x49), 1), 0, 2, 1, 1, faderVal);
		faderVal++;
		addWidget(delay, new ExpLevScrollBarWidget("Center Level", patch, 0, 100, 0, new ParamModel(patch, 0x4B + 8),
				new VSender(0x4B), 1), 0, 3, 1, 1, faderVal);
		faderVal++;
		addWidget(delay, new ExpLevScrollBarWidget("Left Level", patch, 0, 100, 0, new ParamModel(patch, 0x4C + 8),
				new VSender(0x4C), 1), 0, 4, 1, 1, faderVal);
		faderVal++;
		addWidget(delay, new ExpLevScrollBarWidget("Right Level", patch, 0, 100, 0, new ParamModel(patch, 0x4D + 8),
				new VSender(0x4D), 1), 0, 5, 1, 1, faderVal);
		faderVal++;
		addWidget(delay, new ExpLevScrollBarWidget("Feedback", patch, 0, 100, 0, new ParamModel(patch, 0x4E + 8),
				new VSender(0x4E), 1), 0, 6, 1, 1, faderVal);
		faderVal++;
		addWidget(delay, new ExpLevScrollBarWidget("Cutoff", patch, 0, 200, 0, new BigValParamModel(patch, 0x4F + 8),
				new BigValSender(0x4F), 1), 0, 7, 1, 1, faderVal);
		faderVal++;
		addWidget(delay, new GP16CheckBoxWidget("Effect On", patch, new GP16BitModel(patch, 0x0D + 8, 2),
				new GP16BitSender(patch, 0x0D, 2)), 0, 8, 1, 1, checkVal);
		checkVal--;

		delay.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.RAISED), "Tap Delay", TitledBorder.CENTER,
				TitledBorder.CENTER));
		...
		addWidget(reverb, new ExpLevScrollBarWidget("Decay", patch, 0, 75, 0, new ParamModel(patch, 0x51 + 8),
				new VSender(0x51), 1), 0, 0, 1, 1, faderVal);
		faderVal++;
		addWidget(reverb, new GP16ComboBoxWidget("Mode", patch, new ParamModel(patch, 0x52 + 8), new VSender(0x52),
				new String[] { "Room 1", "Room 2", "Room 3", "Hall 1", "Hall 2", "Hall 3", "Plate 1", "Plate 2",
						"Spring 1", "Spring 2" }, true), 0, 1, 1, 1, faderVal);
		faderVal++;
		addWidget(reverb, new ExpLevScrollBarWidget("Cutoff", patch, 0, 200, 0, new BigValParamModel(patch, 0x53 + 8),
				new BigValSender(0x53), 1), 0, 2, 1, 1, faderVal);
		faderVal++;
		addWidget(reverb, new ExpLevScrollBarWidget("Pre Delay", patch, 0, 100, 0, new ParamModel(patch, 0x55 + 8),
				new VSender(0x55), 1), 0, 3, 1, 1, faderVal);
		faderVal++;
		addWidget(reverb, new ExpLevScrollBarWidget("Effect Level", patch, 0, 100, 0, new ParamModel(patch, 0x56 + 8),
				new VSender(0x56), 1), 0, 4, 1, 1, faderVal);
		faderVal++;
		addWidget(reverb, new GP16CheckBoxWidget("Effect On", patch, new GP16BitModel(patch, 0x0D + 8, 3),
				new GP16BitSender(patch, 0x0D, 3)), 0, 5, 1, 1, checkVal);
		checkVal--;

		reverb.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.RAISED), "Reverb", TitledBorder.CENTER,
				TitledBorder.CENTER));
	...
	private ExpLevScrollBarWidget createExpLevScrollBarWidget(String l, PatchDataImpl p, int adress) {
		...
		switch (chosen) {
		case -1:
			return new ExpLevScrollBarWidget(l, p, 0, 0, 0, new BigValParamModel(p, adress + 8), new BigValSender(
					adress), 1);
		case 0:
		case 4:
		case 7:
		case 46:
			return new ExpLevScrollBarWidget(l, p, 0, 100, -50, new BigValParamModel(p, adress + 8), new BigValSender(
					adress), 1);
		case 1:
		case 2:
		case 3:
		...
		case 69:
		case 70:
			return new ExpLevScrollBarWidget(l, p, 0, 100, 0, new BigValParamModel(p, adress + 8), new BigValSender(
					adress), 1);
		case 9:
		case 14:
		case 52:
			return new ExpLevScrollBarWidget(l, p, 0, 1, 0, new BigValParamModel(p, adress + 8), new BigValSender(
					adress), 1);
		case 13:
		case 23:
		case 26:
			return new ExpLevScrollBarWidget(l, p, 0, 40, 10, new BigValParamModel(p, adress + 8), new BigValSender(
					adress), 10);
		case 21:
		case 24:
		case 27:
		case 29:
		case 30:
			return new ExpLevScrollBarWidget(l, p, 0, 48, -24, new BigValParamModel(p, adress + 8), new BigValSender(
					adress), 2);
		case 44:
			return new ExpLevScrollBarWidget(l, p, 0, 200, -100, new BigValParamModel(p, adress + 8), new BigValSender(
					adress), 1);
		case 45:
			return new ExpLevScrollBarWidget(l, p, 0, 24, -12, new BigValParamModel(p, adress + 8), new BigValSender(
					adress), 1);
		case 49:
			return new ExpLevScrollBarWidget(l, p, 0, 3, 0, new BigValParamModel(p, adress + 8), new BigValSender(
					adress), 1);
		case 53:
		case 54:
		case 55:
			return new ExpLevScrollBarWidget(l, p, 0, 1200, 0, new BigValParamModel(p, adress + 8), new BigValSender(
					adress), 1);
		case 60:
		case 63:
			return new ExpLevScrollBarWidget(l, p, 0, 200, 0, new BigValParamModel(p, adress + 8), new BigValSender(
					adress), 1);
		case 61:
			return new ExpLevScrollBarWidget(l, p, 0, 75, 0, new BigValParamModel(p, adress + 8), new BigValSender(
					adress), 1);
		case 62:
			return new ExpLevScrollBarWidget(l, p, 0, 9, 0, new BigValParamModel(p, adress + 8), new BigValSender(
					adress), 1);
		}
		return null;
	}
