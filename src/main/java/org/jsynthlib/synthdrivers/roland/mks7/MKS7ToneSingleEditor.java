...
class MKS7ToneSingleEditor extends PatchEditorFrame {
	public MKS7ToneSingleEditor(Patch patch) {
		...
		addWidget(oscPane, new ComboBoxWidget("Dynamic Affects", patch, new ParamModelBit(patch, 9, 0x60),
				new MKSToneSenderDirect(4, patch, 9), new String[] { "None", "VCA", "VCF", "VCA & VCF" }), 1, 0, 1, 1,
				2);

		addWidget(oscPane, new ComboBoxWidget("Waveform", patch, new ParamModelBit(patch, 21, 24),
				new MKSToneSenderDirect(16, patch, 21), new String[] { "OFF", "PULSE", "SAW", "PULSE+SAW" }), 0, 1, 1,
				1, 3);
		...
		addWidget(oscPane, new ComboBoxWidget("Noise (only for MELODY part)", patch,
				new ParamModelBit(patch, 22, 0x20), new MKSToneSenderDirect(17, patch, 22),
				new String[] { "ON", "OFF" }), 0, 2, 2, 1, 5);
		...
		addWidget(oscPane, new ScrollBarWidget("Sub Level", patch, 0, 3, 0, new ParamModel(patch, 20),
				new MKSToneSender(15)), 0, 6, 3, 1, 8);
		gbc.gridx = 0;
		gbc.gridy = 1;
		gbc.gridwidth = 1;
		gbc.gridheight = 1;
		...
		addWidget(vcfPane, new ScrollBarWidget("Cutoff Freq", patch, 0, 127, 0, new ParamModel(patch, 10),
				new MKSToneSender(5)), 0, 0, 3, 1, 9);
		addWidget(vcfPane, new ScrollBarWidget("Resonance", patch, 0, 127, 0, new ParamModel(patch, 11),
				new MKSToneSender(6)), 0, 1, 3, 1, 10);
		addWidget(vcfPane, new ScrollBarWidget("Env Amount", patch, 0, 127, 0, new ParamModel(patch, 12),
				new MKSToneSender(7)), 0, 2, 3, 1, 11);
		addWidget(vcfPane, new ScrollBarWidget("Key Follow", patch, 0, 127, 0, new ParamModel(patch, 14),
				new MKSToneSender(9)), 0, 3, 3, 1, 12);
		...
		gbc.weightx = 1;
		addWidget(lfoPane, new ScrollBarWidget("LFO Speed", patch, 0, 127, 0, new ParamModel(patch, 5),
				new MKSToneSender(0)), 0, 0, 7, 1, 14);
		addWidget(lfoPane, new ScrollBarWidget("LFO Delay", patch, 0, 127, 0, new ParamModel(patch, 6),
				new MKSToneSender(1)), 0, 1, 7, 1, 15);
		addWidget(lfoPane, new ScrollBarWidget("DCO Mod Depth", patch, 0, 127, 0, new ParamModel(patch, 7),
				new MKSToneSender(2)), 0, 2, 7, 1, 16);
		addWidget(lfoPane, new ScrollBarWidget("PWM Mod Depth", patch, 0, 127, 0, new ParamModel(patch, 8),
				new MKSToneSender(3)), 0, 3, 7, 1, 17);
		addWidget(lfoPane, new ScrollBarWidget("VCF Mod Depth", patch, 0, 127, 0, new ParamModel(patch, 13),
				new MKSToneSender(8)), 0, 4, 7, 1, 18);
		gbc.gridx = 0;
		gbc.gridy = 3;
		gbc.gridwidth = 1;
		gbc.gridheight = 1;
		...
		addWidget(envPane, new EnvelopeWidget(" ", patch, new EnvelopeWidget.Node[] {
				...
				new EnvelopeWidget.Node(0, 127, new ParamModel(patch, 16), 127, 127, null, 10, false,
						new MKSToneSender(11), null, "ATK", null),
				new EnvelopeWidget.Node(0, 127, new ParamModel(patch, 17), 0, 127, new ParamModel(patch, 18), 10,
						false, new MKSToneSender(12), new MKSToneSender(13), "DEC", "SUS"),
				new EnvelopeWidget.Node(127, 127, null, EnvelopeWidget.Node.SAME, 0, null, 0, false, null, null, null,
						null),
				new EnvelopeWidget.Node(0, 127, new ParamModel(patch, 19), 0, 0, null, 0, false, new MKSToneSender(14),
						null, "REL", null), }), 0, 0, 3, 5, 19);
		...
		addWidget(cmnPane, new ScrollBarWidget("VCA Level", patch, 0, 127, 0, new ParamModel(patch, 15),
				new MKSToneSender(10)), 0, 3, 3, 1, 22);
		gbc.gridx = 0;
		gbc.gridy = 1;
		gbc.gridwidth = 1;
		gbc.gridheight = 1;
