 ...
 * entire area size is 24576 bytes. The maximum amount of data in one sysex message in 256 bytes so it needs to create
...
public class RolandJD800BankDriver extends SynthDriverBank {
	...
	public PatchDataImpl createNewPatch() {
		...
		for (int i = 0; i < JD800.nrOfPatchesInABank; i++) {
			System.arraycopy(buffer, JD800.SizeOfSyxHeader, sysex, JD800.SizeOfSyxHeader + i * JD800.SizeOfSinglePatch,
					JD800.MaxSyxDataBlock);
			System.arraycopy(buffer, JD800.SizeOfSyxHeader + JD800.SizeOfPatchSyx1, sysex, JD800.SizeOfSyxHeader
					+ JD800.MaxSyxDataBlock + i * JD800.SizeOfSinglePatch, JD800.SizeOfSinglePatch
					- JD800.MaxSyxDataBlock);
		}
		;
