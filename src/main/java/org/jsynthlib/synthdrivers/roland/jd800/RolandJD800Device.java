...
public class RolandJD800Device extends Device {
	private static final String INFO_TEXT = "This driver supports librarian functions for a single patch, system area, "
	...
	public RolandJD800Device() {
		super("Roland", "JD800", "", INFO_TEXT, "Robert Wirski");
	}
