...
import org.jsynthlib.synthdrivers.roland.d10.D10Constants;
import org.jsynthlib.synthdrivers.roland.d10.Entity;
...
public class D10DataSetMessage extends D10TransferMessage {
	...
	public D10DataSetMessage(Entity bodySize, Entity address) {
		super(D10Constants.CMD_DT1, D10Constants.SIZE_ADDRESS + bodySize.getIntValue(), address.getDataValue());
	}
