...
/**
 * This class holds an integer value which can be retrieved either as an integer value or as a data value in the way the
 * Roland D10 represents large numbers in its transfer protocol. The data value is a representation where only the seven
 * least significant bits of a byte holds information.
 * 
 * The class also provides some arithmetic operations to be performed on the objects of this class.
 * 
...
public class Entity {
	...
	/**
	 * Creates a new entity object which is the sum of this object and the supplied object.
	 * 
	 * @param entity
	...
	/**
	 * Creates a new entity object which is the difference of this object and the supplied object.
	 * 
	 * @param entity
	...
	/**
	 * Creates a new entity object which is the product of this object and the supplied object.
	 * 
	 * @param entity
