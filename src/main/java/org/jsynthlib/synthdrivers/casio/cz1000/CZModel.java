 ...
 * stored in its own byte. So 0xABCD is stored as 0D 0C 0B 0A.
 * <P>
 * Offset constants are relative to the start of the "tone data" (sysex payload area.) The offset to the payload area is
 * 7 for outgoing messages, and 6 for incoming. JSL converts incoming patches to the outgoing format, so patches in
...
/*
 * Rough structure of patch dump from synth. Header is 6 bytes from synth, 7 bytes to synth. 1st column is offset from
 * start of "tone data" area.
 * 
 * sysex: f0 44 00 00 70 30 00 PFLAG 00 00 02 PDS 00 00 04 PDL,PDH 00 00 00 00 08 PVK 08 00 10 PVDLD,V 00 00 00 00 00 00
 * 16 PVSD,V 00 00 00 02 00 00 22 PVDD,V 00 00 01 00 00 00 28 MFW 00 00 00 00 32 MAMD,V 00 00 00 00 36 MWMD,V 00 00 00
 * 00 40 PMAL 07 00 42 PMA 07 07 0f 0f 0c 0b 00 00 0c 03 00 00 0c 03 00 00 58 0c 03 00 00 0c 03 00 00 0c 03 00 00 0c 0b
 * 00 00 74 PMWL 07 00 76 PMW 0f 07 0f 0f 04 0c 00 00 04 04 00 00 04 04 00 00 92 04 04 00 00 04 04 00 00 04 04 00 00 04
 * 0c 00 00 108 PMPL 07 00 110 PMP 00 04 00 08 00 04 00 00 00 04 00 00 00 04 00 00 126 00 04 00 00 00 04 00 00 00 04 00
 * 00 00 0c 00 00 142 SFW 00 00 00 00 146 SAMD,V 00 00 00 00 150 SWMD,V 00 00 00 00 154 PSAL 07 00 156 PSA 07 07 0f 0f
 * 0c 0b 00 00 0c 03 00 00 0c 03 00 00 172 0c 03 00 00 0c 03 00 00 0c 03 00 00 0c 0b 00 00
 * 
 * 188 PSWL 07 00 190 PSW 0f 07 0f 0f 04 0c 00 00 04 04 00 00 04 04 00 00 206 04 04 00 00 04 04 00 00 04 04 00 00 04 0c
 * 00 00 222 PSPL 07 00 224 PSP 00 04 00 08 00 04 00 00 00 04 00 00 00 04 00 00 240 00 04 00 00 00 04 00 00 00 04 00 00
 * 00 0c 00 00 258 end f7
 */
