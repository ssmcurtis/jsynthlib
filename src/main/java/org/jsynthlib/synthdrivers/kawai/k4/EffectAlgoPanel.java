...
class EffectAlgoPanel extends javax.swing.JPanel {
	...
	/**
	 * Draw an arrow from x1,y1 to x2,y2. It has an arrowhead at the x1,y2 point.
	 */
	...
	/**
	 * This method is called as result of the repaint() call. It does all the drawing here.
	 */
	public void paintComponent(Graphics g) {
		...
		g2.setPaint(FG);
		g2.drawString("Effect1", 85 + (100 - fontMetrics.stringWidth("Effect1")) / 2,
		...
		if (effectNumber < 9) {
			...
			g2.setPaint(FG);
			g2.drawString("Effect2", 250 + (100 - fontMetrics.stringWidth("Effect2")) / 2,
					55 + fontMetrics.getMaxAscent() / 2);
			...
			g2.drawString("1->2 Bal.", 220 - fontMetrics.stringWidth("1->2 Bal.") / 2,
					55 + fontMetrics.getMaxAscent() / 2);
		}
	}
