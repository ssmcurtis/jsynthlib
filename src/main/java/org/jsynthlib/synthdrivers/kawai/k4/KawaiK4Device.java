...
public class KawaiK4Device extends Device {
	private static final String INFO_TEXT = "There are no known issues or problems with this synthesizer. Librarian and Editing functions are "
	...
	public KawaiK4Device() {
		super("Kawai", "K4/K4R", "F07E..0602400000040000000000f7", INFO_TEXT, "Brian Klock & Gerrit Gehnen");
	}
