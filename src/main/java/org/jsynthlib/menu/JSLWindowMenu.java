...
/**
 * A Window menu for JSLDesktop and JSLFrame. A JSLFrame is added by <code>add</code> method or is removed when the
 * JSLFrame is closed. A JSLFrame can be activated by the menu entry added.
 * 
 * @see JSLDesktop
 * @see JSLFrame
 * @author Rib Rdb
 ...
 */
public class JSLWindowMenu extends JMenu implements JSLFrameListener, ActionListener {
	...
	private void remove(JSLFrame f) {
		// if (f == null) return;
		ErrorMsgUtil.reportStatus("JSLWindowMenu.remove : " + f.getTitle());
