...
public class _SysexMatcher {
	...
	public _SysexMatcher(byte[] sysex) {
		setSysex(sysex);
	}
	...
	public void setSysex(byte[] sysex) {
		...
		// ErrorMsg.reportStatus("SysexMatcher->setSysex | numSysexMsgs: " + numSysexMsgs + " | size: " +
		// this.sysex.length + " | sSysexHeader: " + sSysexHeader);
	}
