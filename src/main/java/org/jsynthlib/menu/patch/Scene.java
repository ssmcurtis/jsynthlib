 ...
 * song/sound. You can put all needed patches of all used synths in one scene and transfer the whole stuff in one step
 * to your synths.
 * 
 * @version $Id$
...
//	/*
//	 * public Scene() { patch=new Patch(new byte[1024], (Driver) null); bankNumber=0; patchNumber=0; comment=new
//	 * StringBuffer(); }
//	 */
...
//	}
//
//	public Scene(IPatch p, int bankNum, int patchNum) {
//		patch = p;
//		bankNumber = bankNum;
...
//		return (flavor.match(PatchTransferHandler.SCENE_FLAVOR) || flavor.match(PatchTransferHandler.PATCH_FLAVOR));
//	}
//
//	public DataFlavor[] getTransferDataFlavors() {
//		return new DataFlavor[] { PatchTransferHandler.SCENE_FLAVOR, PatchTransferHandler.PATCH_FLAVOR };
//	}
//
