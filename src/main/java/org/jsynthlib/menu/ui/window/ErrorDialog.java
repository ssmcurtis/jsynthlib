...
/**
 * A better implementation to display errors with the chance to look at the stack trace of the causing exception.
 * 
...
public class ErrorDialog extends JDialog {
	...
	public static void showMessageDialog(java.awt.Component parentComponent, Object message, String title,
			int messageType) {
	 ...
	 * @param message
	 * @param title
	 *            The title string of the box
	 * @param messageType
	 * @param e
	 *            The causing exception, which can be displayed on the screen
	 */
	public static void showMessageDialog(java.awt.Component parentComponent, Object message, String title,
			int messageType, Exception e) {
		ErrorDialog dialog = new ErrorDialog((java.awt.Frame) parentComponent, true);
		dialog.setTitle(title);
		dialog.setMessage((String) message);
		...
		/*
		 * If we were given a null instead of a real exception, we should notice that and say so rather than causing a
		 * NullPointerException to get displayed in the dialog, which could be misleading - emenaker 2003.03.18
		 */
	 ...
	 * 
	 * @param exceptionText
	 *            New value of property exceptionText.
	 * 
	 */
