...
public class SysexGetDialog extends JDialog {
	...
	public SysexGetDialog(JFrame parent) { // , Driver driver, int bankNum, int
		...
		JButton getBank = new JButton("GetBank");
		getBank.addActionListener(new GetBankActionListener());
		buttonPanel.add(getBank);
	...
	// --------------------------------------------------------------------------
	// InnerClass: GetBankActionListener
	// --------------------------------------------------------------------------

	public class GetBankActionListener implements ActionListener {
		public void actionPerformed(ActionEvent evt) {
	...
	} // End InnerClass: GetBankActionListener
