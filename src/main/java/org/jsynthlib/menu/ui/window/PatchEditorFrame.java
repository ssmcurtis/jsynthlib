...
//				System.out.println(">>> repaint scroller released hori" );
	...
	public void setVisible(boolean b) {
		if (b) {
			...
			ErrorMsg.reportStatus("PatchEditorFrame.setVisible(): scrollPane size = " + scrollPane.getSize()
	...
	private class FaderReceiver implements Receiver {
		...
		public void send(MidiMessage message, long timeStamp) {
			...
			if (msg.getCommand() == ShortMessage.CONTROL_CHANGE) {
				...
				ErrorMsg.reportStatus("FaderReceiver: channel: " + channel + ", control: " + controller + ", value: "
						+ msg.getData2());
				// use hash !!!FIXIT!!!
