...
public class MidiTest implements Runnable {
	...
	public static boolean runLoopbackTest(int inport, int outport) {
		ErrorMsg.reportWarning("Before we start", "This process is designed to test the communication of\n"
		...
		try {
			...
			ErrorMsg.reportWarning("Congratulations!", "The test appears to have completed successfully.\n"
